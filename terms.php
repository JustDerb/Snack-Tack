...
<?php include "includes/header.php"; ?>
		...
		<ul class="info terms">
			...
			<li>
				...
				on DBA Derby Legleiter Corporation's Internet site, even if DBA Derby Legleiter 
				Corporation or a DBA Derby Legleiter Corporation authorized representative has been 
		...
		<ul class="info terms">
			...
			<li>
				...
				does not warrant that any of the materials on its web site are accurate, complete, 
				or current. DBA Derby Legleiter Corporation may make changes to the materials 
				contained on its web site at any time without notice. DBA Derby Legleiter Corporation 
		...
		<ul class="info terms">
			...
			<li>
				...
				The inclusion of any link does not imply endorsement by DBA Derby Legleiter Corporation 
